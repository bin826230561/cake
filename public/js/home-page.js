...
$(function () {
    ...
    $(".dengLu-success").on("mouseenter", function () {
        $(this).next().slideDown(300);
    });
    $("#header .nav-function li").eq(3).mouseleave(function () {
        $(".user").slideUp(200);
    })
...
$(function () {
    ...
    $(".add_cart").each(function (index, element) {
        $(element).on("click", function () {
            ...
            if (index == 9) {
                $(this).parent().next(".inner-addBuy").children(".inner-addBuy-chose").children("a").eq(0).addClass("border").siblings().removeClass("border");
                $(this).parent().next(".inner-addBuy").children(".inner-addBuy-chose").children("a").eq(0).children().addClass("showI").parent().siblings().children("i").removeClass("showI");
            } else if (index == 11) {
                $(this).parent().next(".inner-addBuy").children(".inner-addBuy-chose").children("a").eq(0).addClass("border").siblings().removeClass("border");
                $(this).parent().next(".inner-addBuy").children(".inner-addBuy-chose").children("a").eq(0).children().addClass("showI").parent().siblings().children("i").removeClass("showI");
            } else if (index == 12) {
                ...
                $(this).parent().next(".inner-addBuy").children(".inner-addBuy-chose").children("a").eq(2).addClass("border").siblings().removeClass("border");
                $(this).parent().next(".inner-addBuy").children(".inner-addBuy-chose").children("a").eq(2).children().addClass("showI").parent().siblings().children("i").removeClass("showI");
            } else if (index == 14) {
                $(this).parent().next(".inner-addBuy").children(".inner-addBuy-chose").children("a").eq(2).addClass("border").siblings().removeClass("border");
                $(this).parent().next(".inner-addBuy").children(".inner-addBuy-chose").children("a").eq(2).children().addClass("showI").parent().siblings().children("i").removeClass("showI");
            } else {
